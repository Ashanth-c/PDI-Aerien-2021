...
/*!
 * @file Aeronef.java
 * @brief Un aéronef represente un element volant d'un aeroport Ã  un autre
...
public class Aeronef extends Position {
	 ...
	 * @return departure, nom de l'aeroport de dÃ©part
	 */
	 ...
	 * @return altitude, la valeur de l'altitude à laquelle l'aeronef vol
	 */
	 ...
	 * @param name Nouveau nom de l'aeronef qui doit etre composé des initiale des aeroports de depart et d'arrive ainsi que d'un numero qui incremente
	 */
	...
	/*!
	 * isFlying()
	 * @brief Vérifie si l'aeronef est en vol
